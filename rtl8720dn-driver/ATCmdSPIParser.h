 ...
 *
 */
#ifndef MBED_ATCMDSPIPARSER_H
#define MBED_ATCMDSPIPARSER_H
...
/** @{*/
/**
 * \defgroup platform_ATCmdSPIParser ATCmdSPIParser class
 * @{
 */
...
class ATCmdSPIParser : private NonCopyable<ATCmdSPIParser> {
private:
    // File handle
...
public:
     ...
     */
    ATCmdSPIParser(PinName mosi, PinName miso, PinName sclk, PinName cs, PinName sync, PinName enable, const char *output_delimiter = "\r",
    ...
    void set_chip_select(bool high);
    void wait_for_mosi_direction();
    void wait_for_miso_direction();
