...
// Various timeouts for different RTL8720DN operations
...
#ifndef RTL8720DN_CONNECT_TIMEOUT
#define RTL8720DN_CONNECT_TIMEOUT 15s
#endif
#ifndef RTL8720DN_SEND_TIMEOUT
#define RTL8720DN_SEND_TIMEOUT    2s
#endif
#ifndef RTL8720DN_RECV_TIMEOUT
#define RTL8720DN_RECV_TIMEOUT    std::chrono::seconds(2)
#endif
#ifndef RTL8720DN_MISC_TIMEOUT
#define RTL8720DN_MISC_TIMEOUT    std::chrono::seconds(2)
#endif
#ifndef RTL8720DN_DNS_TIMEOUT
#define RTL8720DN_DNS_TIMEOUT     15s
#endif

#define RTL8720DN_SCAN_TIME_MIN 0ms
#define RTL8720DN_SCAN_TIME_MAX 1500ms
#define RTL8720DN_SCAN_TIME_MIN_DEFAULT 120ms
#define RTL8720DN_SCAN_TIME_MAX_DEFAULT 360ms

// Firmware version
#define RTL8720DN_SDK_VERSION 2000000
#define RTL8720DN_SDK_VERSION_MAJOR RTL8720DN_SDK_VERSION/1000000

#define RTL8720DN_AT_VERSION 1000000
#define RTL8720DN_AT_VERSION_MAJOR RTL8720DN_AT_VERSION/1000000
#define RTL8720DN_AT_VERSION_TCP_PASSIVE_MODE 1070000
#define RTL8720DN_AT_VERSION_WIFI_SCAN_CHANGE 1060000
...
/** RTL8720DNInterface class.
    This is an interface to a RTL8720DN radio.
 */
class RTL8720DN {
public:
    RTL8720DN(PinName mosi, PinName miso, PinName sclk, PinName cs, PinName sync, PinName enable, bool debug = false);

    /**
    * RTL8720DN firmware SDK version
    *
    ...
    */
    ...
    /**
    * Check AT command interface of RTL8720DN
    *
    ...
    */
    ...
    /**
    * Startup the RTL8720DN
    *
    * @param mode mode of WIFI 1-client, 2-host, 3-both
    * @return true only if RTL8720DN was setup correctly
    */
    ...
    * Reset RTL8720DN
    *
    * @return true only if RTL8720DN resets successfully
    */
    bool reset(void);
    ...
    * @return true only if RTL8720DN enables/disables DHCP successfully
    */
    bool dhcp(bool enabled, int mode);

    /**
    * Connect RTL8720DN to AP
    *
    ...
    */
    ...
    /**
    * Disconnect RTL8720DN from AP
    *
    * @return true only if RTL8720DN is disconnected successfully
    */
    ...
    */
    ...
    /**
    * Get the IP address of RTL8720DN
    *
    ...
    */
    ...
    /**
    * Get the MAC address of RTL8720DN
    *
    ...
    */
    int32_t recv_udp(struct esp8266_socket *socket, void *data, uint32_t amount, mbed::chrono::milliseconds_u32 timeout = RTL8720DN_RECV_TIMEOUT);
    ...
    * @return the number of bytes received
    */
    int32_t recv_tcp(int id, void *data, uint32_t amount, mbed::chrono::milliseconds_u32 timeout = RTL8720DN_RECV_TIMEOUT);
    ...
    */
    void set_timeout(mbed::chrono::milliseconds_u32 timeout = RTL8720DN_MISC_TIMEOUT);
    ...
    */
    ...
    /**
     * Read out SNTP time from RTL8720DN.
     *
     * @param t std::tm structure to be filled in
     * @retval true on success, false otherwise
     *
     * @note RTL8720DN must be connected and needs a couple of seconds
...
private:
    ...
    // SPI settings
    mbed::SPI _spi;
    rtos::Mutex _smutex; // Protect spi port access

    // AT Command Parser
    mbed::ATCmdSPIParser _parser;
    ...
    mbed::Callback<void()> _conn_stat_cb; // RTL8720DNInterface registered
};
#endif
#endif
