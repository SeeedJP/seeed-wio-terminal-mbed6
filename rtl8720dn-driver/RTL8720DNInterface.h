...
#ifndef RTL8720DN_INTERFACE_H
#define RTL8720DN_INTERFACE_H
...
#define RTL8720DN_SOCKET_COUNT 5

#define RTL8720DN_INTERFACE_CONNECT_INTERVAL 5s
#define RTL8720DN_INTERFACE_CONNECT_TIMEOUT (2 * RTL8720DN_CONNECT_TIMEOUT + RTL8720DN_INTERFACE_CONNECT_INTERVAL)

#ifdef TARGET_FF_ARDUINO
#ifndef MBED_CONF_RTL8720DN_TX
#define MBED_CONF_RTL8720DN_TX D1
#endif

#ifndef MBED_CONF_RTL8720DN_RX
#define MBED_CONF_RTL8720DN_RX D0
#endif
#endif /* TARGET_FF_ARDUINO */

#ifndef MBED_CONF_RTL8720DN_COUNTRY_CODE
#define MBED_CONF_RTL8720DN_COUNTRY_CODE "CN"
#endif

#ifndef MBED_CONF_RTL8720DN_CHANNEL_START
#define MBED_CONF_RTL8720DN_CHANNEL_START 1
#endif

#ifndef MBED_CONF_RTL8720DN_CHANNELS
#define MBED_CONF_RTL8720DN_CHANNELS 13
#endif

/** RTL8720DNInterface class
 *  Implementation of the NetworkStack for the RTL8720DN
 */
class RTL8720DNInterface : public NetworkStack, public WiFiInterface {
public:
#if defined MBED_CONF_RTL8720DN_TX && defined MBED_CONF_RTL8720DN_RX
    /**
     * @brief RTL8720DNInterface default constructor
     *        Will use values defined in mbed_lib.json
     */
    RTL8720DNInterface();
#endif

    /** RTL8720DNInterface lifetime
     * @param tx        TX pin
     * @param rx        RX pin
     * @param debug     Enable debugging
     */
    RTL8720DNInterface(PinName mosi = RTL8720D_SPI_MOSI,
                       PinName miso = RTL8720D_SPI_MISO,
                       PinName sclk = RTL8720D_SPI_SCK,
                       PinName cs = RTL8720D_SPI_CS,
                       PinName sync = PA19,
                       PinName enable = PA18,
                       bool debug = false,
                       PinName rst = NC,
    ...
    /**
     * @brief RTL8720DNInterface default destructor
     */
    virtual ~RTL8720DNInterface();
     ...
     *  RTL8720DN_INTERFACE_CONNECT_TIMEOUT_MS + RTL8720DN_CONNECT_TIMEOUT ms.
     *
    ...
    */
     ...
     *
     *  In RTL8720DN the callback will be called when processing OOB-messages via
     *  AT-parser. Do NOT call any RTL8720DNInterface -functions or do extensive
...
private:
     ...
     *  RTL8720DN has two pins serving similar purpose and this function asserts them both
     *  if they are configured in mbed_app.json.
     */
    void _power_off();

    // Credentials
    static const int RTL8720DN_SSID_MAX_LENGTH = 32; /* 32 is what 802.11 defines as longest possible name */
    char ap_ssid[RTL8720DN_SSID_MAX_LENGTH + 1]; /* The longest possible name; +1 for the \0 */
    static const int RTL8720DN_PASSPHRASE_MAX_LENGTH = 63; /* The longest allowed passphrase */
    static const int RTL8720DN_PASSPHRASE_MIN_LENGTH = 8; /* The shortest allowed passphrase */
    char ap_pass[RTL8720DN_PASSPHRASE_MAX_LENGTH + 1]; /* The longest possible passphrase; +1 for the \0 */
    ...
    struct _sock_info _sock_i[RTL8720DN_SOCKET_COUNT];
