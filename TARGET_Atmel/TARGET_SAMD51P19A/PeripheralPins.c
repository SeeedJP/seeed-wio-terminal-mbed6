...
const PinMap PinMap_ADC[] = {
    ...
    // Light Sensor
    {PD01, ADC1_BASE_ADDRESS | ADC_1, PINMUX_PD01B_ADC1_AIN15 | ADC_AIN(15)},
...
const PinMap PinMap_SERCOM[] = {
    ...
    /* SERCOM2 : RPi UART */
    {PB26, SERCOM2_BASE_ADDRESS | SERCOM_2, PINMUX_PB26C_SERCOM2_PAD0 | SERCOM_PAD(0)},
    {PB27, SERCOM2_BASE_ADDRESS | SERCOM_2, PINMUX_PB27C_SERCOM2_PAD1 | SERCOM_PAD(1)},
    /* SERCOM3 : I2C1 */
    ...
    /* SERCOM4 : I2C0 */
    {PA13, SERCOM4_BASE_ADDRESS | SERCOM_4, PINMUX_PA13D_SERCOM4_PAD0 | SERCOM_PAD(0)},
    {PA12, SERCOM4_BASE_ADDRESS | SERCOM_4, PINMUX_PA12D_SERCOM4_PAD1 | SERCOM_PAD(1)},
    /* SERCOM5 : RPi SPI */
